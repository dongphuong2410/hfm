...
static const char *win_offset_names[WIN_OFFSETS_MAX][2] = {
    ...
    [FILE_OBJECT__VPB] = { "_FILE_OBJECT", "Vpb" },
    [FILE_OBJECT__SECTION_OBJECT_POINTER] = { "_FILE_OBJECT", "SectionObjectPointer" },
    [VPB__VOLUME_LABEL] = { "_VPB", "VolumeLabel" },
    [VPB__VOLUME_LABEL_LENGTH] = { "_VPB", "VolumeLabelLength" },
    ...
    [DEVICE_OBJECT__DRIVER_OBJECT] = { "_DEVICE_OBJECT", "DriverObject" },
    [DRIVER_OBJECT__DRIVER_NAME] = { "_DRIVER_OBJECT", "DriverName" },
    [DEVICE_OBJECT__VPB] = { "_DEVICE_OBJECT", "Vpb" },
    [PEB__PROCESS_PARAMETERS] = { "_PEB", "ProcessParameters" },
    [RTL_USER_PROCESS_PARAMETERS__CURRENT_DIRECTORY] = { "_RTL_USER_PROCESS_PARAMETERS", "CurrentDirectory" },
    [RTL_USER_PROCESS_PARAMETERS__IMAGE_PATH_NAME] = { "_RTL_USER_PROCESS_PARAMETERS", "ImagePathName" },
    [CURDIR__DOS_PATH] = { "_CURDIR", "DosPath" },
