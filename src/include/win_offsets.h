...
enum win_offsets {
    ...
    HANDLE_TABLE_ENTRY__OBJECT_POINTER_BITS,
    OBJECT_HEADER__BODY,
    ...
    FILE_BASIC_INFORMATION__FILE_ATTRIBUTES,
    OBJECT_TYPE__INDEX,
    EPROCESS__PEB,
    ...
    EPROCESS__TOKEN,
    TOKEN__USER_AND_GROUPS,
    SID_AND_ATTRIBUTES__SID,
    ...
    SECURITY_DESCRIPTOR__CONTROL,
    SECURITY_DESCRIPTOR__OWNER,
    SECURITY_DESCRIPTOR__GROUP,
    SECURITY_DESCRIPTOR_RELATIVE__OWNER,
...
static const char *win_offset_names[WIN_OFFSETS_MAX][2] = {
    ...
    [KTHREAD__APC_STATE] = { "_KTHREAD", "ApcState" },
    [KAPC_STATE__PROCESS] = { "_KAPC_STATE", "Process" },
    ...
    [HANDLE_TABLE_ENTRY__OBJECT_POINTER_BITS] = { "_HANDLE_TABLE_ENTRY", "ObjectPointerBits" },
    ...
    [FILE_BASIC_INFORMATION__FILE_ATTRIBUTES] = { "_FILE_BASIC_INFORMATION", "FileAttributes" },
    ...
    [EPROCESS__TOKEN] = { "_EPROCESS", "Token" },
    [TOKEN__USER_AND_GROUPS] = { "_TOKEN", "UserAndGroups" },
    [SID_AND_ATTRIBUTES__SID] = { "_SID_AND_ATTRIBUTES", "Sid" },
    ...
    [SECURITY_DESCRIPTOR__CONTROL] = { "_SECURITY_DESCRIPTOR", "Control" },
    [SECURITY_DESCRIPTOR__OWNER] = { "_SECURITY_DESCRIPTOR", "Owner" },
    [SECURITY_DESCRIPTOR__GROUP] = { "_SECURITY_DESCRIPTOR", "Group" },
    [SECURITY_DESCRIPTOR_RELATIVE__OWNER] = { "_SECURITY_DESCRIPTOR_RELATIVE", "Owner" },
    [SECURITY_DESCRIPTOR_RELATIVE__GROUP] = { "_SECURITY_DESCRIPTOR_RELATIVE", "Group" }
};
